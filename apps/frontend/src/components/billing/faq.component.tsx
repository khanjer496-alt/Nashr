  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              `Am I going to be charged by ${brand.name}?`
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              `To confirm credit card information ${brand.name} will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person`
            ),
          },
        ]
      : []),
    ...
    },
    {
      ...
      description: t(
        ...
        `${brand.name} allows you to schedule your posts between different channels.
