      ...
      <div
        ...
        className={clsx(
          !modal.fullScreen
            ...
            : 'w-full h-full',
          'fixed flex start-0 top-0 bg-popup transition-all animate-fadeIn overflow-y-auto text-newTextColor',
        ...
        <div className={clsx(modal.fullScreen && 'flex', 'relative flex-1')}>
          <div
            className={clsx(
              modal.fullScreen
                ? 'flex flex-1'
                : 'absolute top-0 start-0 min-w-full min-h-full'
            )}
          >
            <div
              className={clsx(
  ...
  return (
    <CurrentModalContext.Provider value={{ id: modal.id }}>
      <div
        ...
        style={{ zIndex }}
        className={clsx(
          'fixed flex start-0 top-0 min-w-full min-h-full bg-popup transition-all animate-fadeIn overflow-y-auto text-newTextColor',
