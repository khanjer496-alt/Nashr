...
export const SelectCurrent: FC = () => {
  ...
  return (
    <>
      <div className="select-none start-0 absolute w-full z-[100] px-[20px]">
        <div
          ref={contentRef}
          className={clsx(
        ...
        >
          <div
            ...
            className={clsx(
              ...
              current !== 'global'
                ? 'text-[#A3A3A3]'
                : 'border border-[#8D78FF] text-[#8D78FF]'
            )}
          >
            <div>
              <GlobalIcon />
...
export const IsGlobal: FC<{ id: string }> = ({ id }) => {
  ...
  return (
    <div
      ...
      className="w-[8px] h-[8px] bg-[#8D78FF] -top-[1px] -end-[3px] absolute rounded-full"
    />
  );
};
