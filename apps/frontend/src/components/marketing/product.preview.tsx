...
export function ProductPreview() {
  return (
    <div className={styles.productPreview} aria-label="Orbiloom post composer and approval workflow preview">
      <div className={styles.previewChrome}><div><i /><i /><i /></div><span>app.orbiloom.com / composer</span><b>LIVE</b></div>
      <div className={styles.previewBody}>
        <aside className={styles.previewRail}><strong>O</strong><span className={styles.railActive}>＋</span><span>⌂</span><span>▦</span><span>◫</span><span>⌁</span></aside>
        <section className={styles.composerPane}>
          ...
          <div className={styles.mediaTile}><span>ORBILOOM</span><strong>Put every channel<br />in motion.</strong></div>
