/**
 * Nashr (نشر) — self-contained Jest config for libraries/nashr-permissions.
 *
...
module.exports = {
  ...
  testMatch: ['<rootDir>/libraries/nashr-permissions/src/**/*.spec.ts'],
  moduleNameMapper: {
